...
function GetBooking() {
    let url = 'https://api.sheety.co/2ccedded47d6080970578b28d04f8693/bookingApp/bookings';
    fetch(url)
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/2ccedded47d6080970578b28d04f8693/bookingApp/bookings/' + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then(() => {
